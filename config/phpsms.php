...
return [
    ...
    'agents' => [
        ...
        'YunXinShi' => [
            ...
            'uid'    => env('YUNXINSHI_UID'),
            'pwd'    => env('YUNXINSHI_PWD'),
        ],
        ...
        'TinRee' => [
            ...
            'accesskey' => env('TINREE_KEY', 'FJwo1iwATTapyWls'),
            'secret'    => env('TINREE_SECRET', 'kfQsnuglDBROSbNZcukWt26ZNGpFnBiY'),
            'sign'      => env('TINREE_SIGN', '【安拓网络】'),
        ],
         ...
         */
        'Aliyun' => [
            'accessKeyId'       => 'LTAIqbFtnr2McdtR',
            'accessKeySecret'   => 'UieXJZWItHwVxciCegMgclrwl9KWJe',
            'signName'          => '安拓网络',
